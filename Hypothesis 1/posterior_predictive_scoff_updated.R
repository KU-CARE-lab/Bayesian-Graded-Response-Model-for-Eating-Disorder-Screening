...
boxplot(est_freq,main="SCOFF score: Cisgender men",xlab="Sum score",ylab="Proportion",
        at=0:5,names=0:5)
...
boxplot(est_freq,main="SCOFF score: Cisgender women",xlab="Sum score",ylab="Proportion",
        at=0:5,names=0:5)
lines(0:5,true_freq,type="o",col='red')
...
boxplot(est_freq,main="SCOFF score: Non-cisgender",xlab="Sum score",ylab="Proportion",
        at=0:5,names=0:5)
lines(0:5,true_freq,type="o",col='red')
