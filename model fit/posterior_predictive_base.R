...
boxplot(est_freq,main="BASE: Cisgender men",xlab="Aggregated score",ylab="Proportion in population",
...
boxplot(est_freq,main="BASE: Cisgender women",xlab="Aggregated score",ylab="Proportion in population",
        at=0:40,outline=F,names=0:40)
lines(0:40,true_freq,type="o",col='red')
...
boxplot(est_freq,main="BASE: Non-cisgender",xlab="Aggregated score",ylab="Proportion in population",
        at=0:40,outline=F,names=0:40)
lines(0:40,true_freq,type="o",col='red')
